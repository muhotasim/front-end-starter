...
const ForgotPasswordPage:React.FC = ()=>{
    ...
    const {isLoading, forgotPasswordMailSend, error} = useSelector(((state:RootState)=>state.users))
    ...
    useEffect(()=>{
        ...
        dispatch(userActions.updateState({forgotPasswordMailSend: false, error: null}));
    },[])
